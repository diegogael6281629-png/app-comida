...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas() {
        ...
        peliculas.add(Pelicula("Vidas Pasadas", R.drawable.vidaspasadas, R.drawable.vidaspasadas, "Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica semana para enfrentarse al amor y al destino.",arrayListOf<Cliente>()))
    }
    ...
    fun cargarSeries() {
        ...
        series.add(Pelicula("Mi adorable demonio", R.drawable.adorabledemonio1, R.drawable.adorabledemonios2,"Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.",arrayListOf<Cliente>()))
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.elmonstruovieja2,"Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.",arrayListOf<Cliente>()))
